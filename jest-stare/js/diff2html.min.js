    ...
    (e = {
      ...
      913: (e, t) => {
        ...
        function i(e, t, n, i, r) {
          for (var a = 0, o = t.length, s = 0, l = 0; a < o; a++) {
            ...
            if (f.removed) {
              if (
                ((f.value = e.join(i.slice(l, l + f.count))), (l += f.count), a && t[a - 1].added)
              ) {
                var u = t[a - 1];
                (t[a - 1] = t[a]), (t[a] = u);
              }
            ...
            diff: function (e, t) {
              ...
              function h() {
                for (var n = -1 * u; n <= u; n += 2) {
                  ...
                  if (b || g) {
                    if (
                      (!b || (g && d.newPos < p.newPos)
                        ? ((a = r(p)), o.pushComponent(a.components, void 0, !0))
                        : ((a = d).newPos++, o.pushComponent(a.components, !0, void 0)),
      ...
      276: (e, t, n) => {
        ...
        function f(e, t, n, i, r) {
          ...
          if ((e && e.toJSON && (e = e.toJSON()), 'object' === o(e) && null !== e)) {
            ...
            var u,
              d = [];
            for (u in e) e.hasOwnProperty(u) && d.push(u);
            for (d.sort(), a = 0; a < d.length; a += 1) l[(u = d[a])] = f(e[u], t, n, i, u);
            t.pop(), n.pop();
          } else l = e;
          return l;
        }
          ...
          (t.merge = function (e, t, n) {
            ...
            (e.index || t.index) && (i.index = e.index || t.index),
              (e.newFileName || t.newFileName) &&
                (u(e)
                  ? u(t)
                    ? ((i.oldFileName = d(i, e.oldFileName, t.oldFileName)),
                      (i.newFileName = d(i, e.newFileName, t.newFileName)),
                      (i.oldHeader = d(i, e.oldHeader, t.oldHeader)),
                      (i.newHeader = d(i, e.newHeader, t.newHeader)))
            ...
            for (var r = 0, a = 0, o = 0, s = 0; r < e.hunks.length || a < t.hunks.length; ) {
              ...
              if (c(l, b)) i.hunks.push(p(l, o)), r++, (s += l.newLines - l.oldLines);
              else if (c(b, l)) i.hunks.push(p(b, s)), a++, (o += b.newLines - b.oldLines);
              else {
                var g = {
        ...
        function h(e, t, n, i, r) {
          ...
          for (m(e, a, s), m(e, s, a); a.index < a.lines.length && s.index < s.lines.length; ) {
            ...
            if (('-' !== f[0] && '+' !== f[0]) || ('-' !== u[0] && '+' !== u[0]))
              if ('+' === f[0] && ' ' === u[0]) {
                var d;
                (d = e.lines).push.apply(d, o(w(a)));
              } else if ('+' === u[0] && ' ' === f[0]) {
                var c;
                (c = e.lines).push.apply(c, o(w(s)));
              } else
                '-' === f[0] && ' ' === u[0]
                  ? g(e, a, s)
                  : '-' === u[0] && ' ' === f[0]
        ...
        !(function (e) {
            ...
            (e.scan = function (n, i) {
              ...
              function y(n, i) {
                if (
                  ...
                  n &&
                    (function () {
                      for (var n = !0, i = b; i < c.length; i++)
                        if (
                          !(n =
                            e.tags[c[i].tag] < e.tags._v ||
                            ('_t' == c[i].tag && null === c[i].text.match(t)))
                        )
                          return !1;
                      return n;
                    })())
                )
                  for (var r, a = b; a < c.length; a++)
                    c[a].text &&
                      ((r = c[a + 1]) && '>' == r.tag && (r.indent = c[a].text.toString()),
                      c.splice(a, 1));
                else i || c.push({ tag: '\n' });
                (p = !1), (b = c.length);
              }
                ...
                0 == o
                  ...
                  ? (c.push({
                    ...
                    '{' == s &&
                      ('}}' == v
                        ? h++
                        : '}' === (r = c[c.length - 1]).n.substr(r.n.length - 1) &&
          ...
          function d(t, n, i, r) {
            ...
            for (a = i[i.length - 1]; t.length > 0; ) {
              ...
              if (e.tags[l.tag] <= e.tags.$ || c(l, r)) i.push(l), (l.nodes = d(t, l.tag, i, r));
              else {
                if ('/' == l.tag) {
          ...
          function h(e) {
            ...
            for (var n in e.partials)
              t.push(
                '"' + g(n) + '":{name:"' + g(e.partials[n].name) + '", ' + h(e.partials[n]) + '}'
              );
            return (
              'partials: {' +
              t.join(',') +
        ...
        t.parse = function (e, t) {
          ...
          function A(e) {
            ...
            D(),
              null !== i &&
                ((t = /^@@ -(\d+)(?:,\d+)? \+(\d+)(?:,\d+)? @@.*/.exec(e))
                  ? ((i.isCombined = !1), (l = parseInt(t[1], 10)), (d = parseInt(t[2], 10)))
                  ...
                  : (e.startsWith(g) && console.error('Failed to parse lines, starting in 0!'),
                    ...
                    (d = 0),
                    (i.isCombined = !1))),
              (a = { lines: [], oldStartLine: l, oldStartLine2: u, newStartLine: d, header: e });
          }
          return (
                ...
                if (e.startsWith('diff --git') || e.startsWith('diff --combined')) {
                  if (
                    ...
                    (D = /^diff --git "?([a-ciow]\/.+)"? "?([a-ciow]\/.+)"?/.exec(e)) &&
                      ((c = f(D[1], void 0, t.dstPrefix)), (p = f(D[2], void 0, t.srcPrefix))),
                    null === i)
                  )
                    throw new Error('Where is my file !!!');
                  i.isGitDiff = !0;
                } else if (!e.startsWith('Binary files') || (null == i ? void 0 : i.isGitDiff)) {
                  if (
                    ((!i ||
                      (!i.isGitDiff &&
                        i &&
                    ...
                    if (
                      (e.startsWith(h) && W.startsWith(b)) ||
                      (e.startsWith(b) && F.startsWith(h))
                    ) {
                      if (
                        i &&
                        !i.oldName &&
                    ...
                    if (i && (e.startsWith(g) || (i.isGitDiff && i.oldName && i.newName && !a)))
                      A(e);
                    else if (a && (e.startsWith('+') || e.startsWith('-') || e.startsWith(' ')))
                      !(function (e) {
                        if (null !== i && null !== a && null !== l && null !== d) {
                          var t = { content: e },
                            n = i.isCombined ? ['+ ', ' +', '++'] : ['+'],
                            o = i.isCombined ? ['- ', ' -', '--'] : ['-'];
                          s(e, n)
                  ...
                  if (
                    (I(),
                    (D = /^Binary files "?([a-ciow]\/.+)"? and "?([a-ciow]\/.+)"? differ/.exec(
                      e
                    )) && ((c = f(D[1], void 0, t.dstPrefix)), (p = f(D[2], void 0, t.srcPrefix))),
                    null === i)
                  )
      ...
      834: function (e, t, n) {
        ...
        (t.defaultDiff2HtmlConfig = i(
          i(i({}, u.defaultLineByLineRendererConfig), d.defaultSideBySideRendererConfig),
            ...
            return (
              ...
              (e.prototype.makeFileDiffHtml = function (e, t) {
                if (
                  ...
                  return '';
                var n = this.hoganUtils.template(d, 'file-diff'),
                      ...
                      t.applyLineGroupping(i).forEach(function (i) {
                        ...
                        if (o.length && s.length && !a.length)
                          t.applyRematchMatching(o, s, n).map(function (n) {
                            var i = n[0],
                              a = n[1],
                              o = t.processChangedLines(e, e.isCombined, i, a),
                              s = o.left,
                              l = o.right;
                            (r += s), (r += l);
                          });
                          ...
                          var f = t.processChangedLines(e, e.isCombined, o, s),
                            u = f.left,
                            d = f.right;
                          (r += u), (r += d);
                        } else
              ...
              (e.prototype.processChangedLines = function (e, t, n, r) {
                for (
                  var a = { right: '', left: '' }, o = Math.max(n.length, r.length), s = 0;
                  s < o;
                  s++
                ) {
                  var f = n[s],
                    ...
                    d =
                      void 0 !== f && void 0 !== u
                        ? l.diffHighlight(f.content, u.content, t, this.config)
                        : void 0,
                    c =
                      void 0 !== f && void 0 !== f.oldNumber
                        ? i(
                            i(
                              {},
                              void 0 !== d
                                ...
                                : i(i({}, l.deconstructLine(f.content, t)), {
                        ...
                        ? i(
                            i(
                              ...
                              void 0 !== d
                                ...
                                : i(i({}, l.deconstructLine(u.content, t)), {
                                    type: l.toCSSClass(u.type),
                                  })
                            ),
                            { oldNumber: u.oldNumber, newNumber: u.newNumber }
                          )
                        : void 0,
                    h = this.generateLineHtml(e, c, p),
                    b = h.left,
                    g = h.right;
                  (a.left += b), (a.right += g);
                }
              ...
              (e.prototype.generateLineHtml = function (e, t, n) {
                return {
                  left: this.generateSingleLineHtml(e, t),
                  right: this.generateSingleLineHtml(e, n),
                };
              }),
              (e.prototype.generateSingleLineHtml = function (e, t) {
                if (void 0 === t) return '';
                var n = this.hoganUtils.render(d, 'numbers', {
          ...
          (t.newMatcherFn = function (e) {
            return function t(n, i, r, a) {
              ...
              return (
                ...
                (n.length > d || i.length > c) && (m = m.concat(v)),
                m
              );
            };
          });
      ...
      741: function (e, t, n) {
        ...
        function m(e) {
          ...
          var c = i.join(d),
            p = r.join(d),
            b = a.slice(s, f + 1).join(d),
            g = o.slice(s, u + 1).join(d);
        ...
        (t.toCSSClass = function (e) {
          ...
          (t.getHtmlId = function (e) {
            return 'd2h-'.concat((0, l.hashCode)(m(e)).toString().slice(-6));
          }),
            ...
            var x,
              C = y.reduce(function (e, t) {
                var n = t.added ? 'ins' : t.removed ? 'del' : null,
                  ...
                  r = g(t.value);
                return null !== n
                  ? ''.concat(e, '<').concat(n).concat(i, '>').concat(r, '</').concat(n, '>')
                  : ''.concat(e).concat(r);
              }, '');
            return {
              oldLine: {
