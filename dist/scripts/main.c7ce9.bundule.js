...
*/
  ...
  (() => {
    ...
    var client = __webpack_require__(745); // CONCATENATED MODULE: ./node_modules/@remix-run/router/dist/router.js
    /**
    ...
    function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
      ...
      function createURL(to) {
        ...
        let base =
          window.location.origin !== 'null' ? window.location.origin : window.location.href;
    ...
    function router_createRouter(init) {
      ...
      function completeNavigation(location, newState) {
        ...
        let isActionReload =
          ...
          ((_location$state = location.state) == null ? void 0 : _location$state._isRedirect) !==
            true;
        let actionData;
        ...
        else if (pendingAction === router_Action.Push) {
      ...
      async function handleFetcherAction(key, routeId, path, match, requestMatches, submission) {
        ...
        let matches =
          state.navigation.state !== 'idle'
            ? router_matchRoutes(routesToUse, state.navigation.location, basename)
            : state.matches;
    ...
    function normalizeTo(location, matches, basename, prependBasename, to, fromRouteId, relative) {
      ...
      let path = router_resolveTo(
        ...
        router_stripBasename(location.pathname, basename) || location.pathname,
        relative === 'path'
      ...
      if (prependBasename && basename !== '/') {
        path.pathname =
          path.pathname === '/' ? basename : router_joinPaths([basename, path.pathname]);
      }
    ...
    function getTargetMatch(matches, location) {
      let search =
        typeof location === 'string' ? router_parsePath(location).search : location.search;
    ...
    const DataRouterContext =
      /*#__PURE__*/ /* unused pure expression or super */ null && React.createContext(null);
    ...
    const navigateEffectWarning =
      ...
      'You should call navigate() in a React.useEffect(), not when ' +
        'your component is first rendered.'; // Mute warnings for calls to useNavigate in SSR environments
    ...
    function dist_useNavigate() {
      let { isDataRoute } = React.useContext(RouteContext); // Conditional usage is OK here because the usage of a data router is static
      // eslint-disable-next-line react-hooks/rules-of-hooks
    ...
    function useNavigateUnstable() {
      ...
      let routePathnamesJson = JSON.stringify(
        UNSAFE_getPathContributingMatches(matches).map(match => match.pathnameBase)
      );
    ...
    const defaultErrorElement =
      ...
      React.createElement(DefaultErrorComponent, null);
    ...
    const Link =
      ...
      React.forwardRef(function LinkWithRef(_ref4, ref) {
        let { onClick, relative, reloadDocument, replace, state, target, to, preventScrollReset } =
            _ref4,
    ...
    function useSubmitImpl(fetcherKey, fetcherRouteId) {
      let { router } = dist_useDataRouterContext(dist_DataRouterHook.UseSubmitImpl);
      ...
      return React.useCallback(
        function (target, options) {
          ...
          if (fetcherKey) {
            ...
            router.navigate(
              action,
              react_router_dom_dist_extends({}, opts, {
    ...
    function useScrollRestoration(_temp3) {
      ...
      let { restoreScrollPosition, preventScrollReset } = dist_useDataRouterState(
        dist_DataRouterStateHook.UseScrollRestoration
      );
      let location = useLocation();
    ...
    const App = () => {
      const [baozi, setBaozi] = (0, react.useState)(0);
      return /*#__PURE__*/ (0, jsx_runtime.jsxs)('div', {
        children: [
          ...
          /*#__PURE__*/ (0, jsx_runtime.jsx)('button', {
            onClick: () => setBaozi(baozi + 1),
            children: '按钮',
          }),
        ],
      });
    };
    /* harmony default export */ const pages_App = App; // CONCATENATED MODULE: ./src/index.tsx

    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    const container = document.getElementById('main');
    const root = (0, client /* createRoot */.s)(container);
    root.render(
      /*#__PURE__*/ (0, jsx_runtime.jsx)(BrowserRouter, {
...
//# sourceMappingURL=main.c7ce9.bundule.js.map
